...
export const PERMISSION_ITEMS: PermissionItem[] = [
  ...
  { code: PERMISSIONS.deliveryRelease, label: '现结出库放行', description: '授权放行存在未结清现结款项的出库单' },
  ...
  { code: PERMISSIONS.settleDiscountAdminApprove, label: '大额结算优惠审批', description: '审批超过财务复核额度或比例的结算优惠' },
...
export const PERMISSION_GROUPS: PermissionGroup[] = [
  ...
  },
  {
    ...
    permissions: [PERMISSIONS.deliveryView, PERMISSIONS.deliveryManage, PERMISSIONS.deliveryRelease],
  },
  {
    key: 'settle',
    title: '结算收款',

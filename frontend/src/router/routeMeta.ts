...
export const routeMeta: AppRouteMeta[] = [
  ...
  { path: '/project-memory', label: '项目记忆', parentLabel: '系统管理', group: 'system' },
  { path: '/ai-memory-review', label: 'AI记忆审核', parentLabel: '系统管理', group: 'system' },
  ...
  { path: '/process-orders/:uuid/append', label: '追加母卷', parentLabel: '加工单', menuKey: '/process-orders' },
  ...
  ...(RELEASE_FEATURES.remainModuleEnabled ? [{ path: '/remain', label: '余料业务' }] : []),

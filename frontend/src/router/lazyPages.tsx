...
export const AppendOrderPage = lazy(() => import('../pages/processOrder/AppendOrderPage'))
...
export const ProjectMemoryPage = lazy(() => import('../pages/projectMemory/ProjectMemoryPage'))
export const AiMemoryReviewPage = lazy(() => import('../pages/projectMemory/AiMemoryReviewPage'))
export const ReportPage = lazy(() => import('../pages/report/ReportPage'))
export const ReportTopicPage = lazy(() => import('../pages/report/ReportTopicPage'))
export const ReportOperationalPage = lazy(() => import('../pages/report/ReportOperationalPage'))
export const ReportExplorerPage = lazy(() => import('../pages/report/ReportExplorerPage'))
export const ReportSavedViewsPage = lazy(() => import('../pages/report/ReportSavedViewsPage'))
export const ReportAutomationPage = lazy(() => import('../pages/report/ReportAutomationPage'))
export const ReportMetricManagementPage = lazy(() => import('../pages/report/ReportMetricManagementPage'))
export const ReportPendingPage = lazy(() => import('../pages/report/ReportPendingPage'))

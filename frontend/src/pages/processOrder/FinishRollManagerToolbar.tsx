  ...
  return (
    <div className="finish-roll-toolbar">
      ...
      <Space className="finish-roll-toolbar__filters" size={8}>
        ...
        <Select aria-label="来源类型" allowClear placeholder="来源类型" value={state.filters.source} onChange={(value) => update('source', value)} options={[{ value: 1, label: '加工产出' }, { value: 2, label: '母卷直发' }, { value: 3, label: '整理成品' }]} />
      </Space>
    </div>
  )
}

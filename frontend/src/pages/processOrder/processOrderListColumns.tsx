...
export interface ProcessOrderColumnOptions {
...
export function buildProcessOrderColumns(options: ProcessOrderColumnOptions): ProColumns<ProcessOrder>[] {
  return [
    ...
    { title: '操作', key: 'actions', valueType: 'option', width: 160, minWidth: 150, fixed: 'right', render: (_, record) => <ProcessOrderRowActions record={record} {...options} /> },
  ]
}

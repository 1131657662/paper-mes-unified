...
import { formatSettleOriginalWeight } from './settleOriginalWeight'
...
export const settlePrintLineColumns: ColumnsType<SettlePrintLine> = [
  ...
  { title: '原纸重量', dataIndex: 'originalWeight', align: 'right', width: 180,
    render: (_, record) => formatSettleOriginalWeight(record) },

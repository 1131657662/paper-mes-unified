...
export default function FinishConfigPlanPreviewPanel({ preview, loading }: Props) {
  if (loading) {
    return (
  ...
  return (
    <div>
      <Descriptions size="small" column={2} style={{ marginBottom: 12 }}>
        ...
        <Descriptions.Item label="预估总重">{formatOptionalKg(totalEstimateWeight)}</Descriptions.Item>
        <Descriptions.Item label="修边总重">{formatOptionalKg(totalTrimWeight)}</Descriptions.Item>
      </Descriptions>

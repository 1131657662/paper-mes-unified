-- V3.39: add immutable customer-facing delivery document corrections.
-- Safe to rerun. The signed delivery snapshot remains unchanged.
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Customer-facing delivery document revisions';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COMMENT='Customer-facing values per delivery revision';

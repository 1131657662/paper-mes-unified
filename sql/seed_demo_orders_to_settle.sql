...
('demo-step-a-4', @order_a, 'demo-a-orig-4', 1, 2, '普通复卷', 1, 0, 7500.000, 120.00, 900.00, 45.000, '李师傅', '改门幅 840×3'),
('demo-step-b-1', @order_b, 'demo-b-orig-1', 1, 2, '模式1改门幅', 1, 0, 2500.000, 135.00, 337.50, 60.000, '赵师傅', '950×2，剩余转修边'),
('demo-step-b-2', @order_b, 'demo-b-orig-2', 1, 2, '模式2改直径', 1, 0, 2500.000, 135.00, 337.50, 70.000, '赵师傅', '2000mm门幅不变，φ650×2'),
('demo-step-b-3', @order_b, 'demo-b-orig-3', 1, 2, '模式3改直径+门幅', 1, 0, 3000.000, 135.00, 405.00, 75.000, '赵师傅', '1000mm×2段，φ650'),
('demo-step-b-4', @order_b, 'demo-b-orig-4', 1, 2, '模式4内外层分层', 1, 0, 2944.000, 135.00, 397.50, 85.000, '赵师傅', '内层900 外层1100'),
('demo-step-b-5', @order_b, 'demo-b-orig-5', 1, 2, '模式5多母卷合并', 1, 0, 2944.000, 135.00, 397.50, 90.000, '赵师傅', 'B-MW-005 70% + B-MW-006 30% 接纸');

...
public class ProcessOrderQueryIntegrityBootstrap implements ApplicationRunner {

    static final String TABLE = "biz_process_order";
    static final String INDEX = "idx_customer_deleted_ctime";
    ...
    public void run(ApplicationArguments args) {
        ...
        jdbcTemplate.execute("""
                ...
                ADD INDEX `idx_customer_deleted_ctime` (`customer_uuid`, `is_deleted`, `create_time`)
                """);
    }

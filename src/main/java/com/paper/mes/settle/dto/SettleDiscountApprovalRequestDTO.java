...
public class SettleDiscountApprovalRequestDTO {
    ...
    @PositiveOrZero(message = "实际到账金额不能为负数")
    private BigDecimal cashAmount;

    @NotNull(message = "废纸抵扣金额不能为空")
    @PositiveOrZero(message = "废纸抵扣金额不能为负数")
    ...
    @NotNull(message = "未收金额快照不能为空")
    @PositiveOrZero(message = "未收金额快照不能为负数")
